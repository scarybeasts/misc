MODE7:VDU129,157,131:PRINT"Disc BEAST v0.2":PRINT
IF TOP>&4200 THEN PRINT"MEMORY!":END
...
IF A$="FSYS" THEN F$=Q$:G%(6)=-1:PRINT"FSYS "+F$
...
DEF PROCpcrc:VDU130:PRINT "DISC CRC32 "+STR$~(!(C%+4)):ENDPROC
