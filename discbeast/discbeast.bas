MODE7:HIMEM=&4800
VDU129,157,131:PRINT"Disc BEAST v0.3":PRINT
REM BSTASM
D%=&7000+&100:Z%=&70
REM DUTLASM
U%=&7A00:W%=&50
...
FOR T%=1 TO 39 STEP 2
PROCseek:PROCrids:R%=R% AND &FF
PRINT"TRACK "+STR$(T%)+" READ IDS: &"+STR$~(R%)
IF R%=0 THEN T%=39 ELSE IF R%<>&18 THEN G%(5)=1:T%=39
NEXT
I%=80-G%(5)*40
PRINT"AUTO DISC TRACKS: "+STR$(I%)
IF V%(1)=-1 THEN V%(7)=I%
ENDPROC
