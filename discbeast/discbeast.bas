...
V%(4)=V%(4)-1
PROCtrk
IF R%<>0 THEN PRINT"(RETRY) ";:PROCwait(200):I%=T%:V%(0)=0:PROCseek:V%(0)=I%:PROCseek:R%=1
UNTIL R%=0 OR V%(4)=0
...
V%(4)=V%(4)-1
PROCtrk
IF R%<>0 THEN VDU7,8,8,129,33:PROCwait(200):I%=T%:V%(0)=0:PROCseek:V%(0)=I%:PROCseek:R%=1
UNTIL R%=0 OR V%(4)=0
